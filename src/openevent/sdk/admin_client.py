...
from .client import _DEFAULT_CHANNEL_OPTIONS
...
class AdminClient:
    ...
    def add_token(self, target_principal: int):
        return self.stub.AddToken(admin_pb2.AddTokenRequest(target_principal=target_principal))

    def delete_token(self, target_token: str):
        return self.stub.DeleteToken(admin_pb2.DeleteTokenRequest(target_token=target_token))
